locals {
  PrivateSubnet1 = data.terraform_remote_state.vpc_networking.outputs.PvtSN1_id
  PrivateSubnet2 = data.terraform_remote_state.vpc_networking.outputs.PvtSN2_id
}
...
resource "aws_eks_cluster" "eks-cluster" {
  ...
  vpc_config {
    subnet_ids = [local.PrivateSubnet1, local.PrivateSubnet2]
  }
